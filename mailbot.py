...
# Email and dataset configuration
...
Best Regards, Sujal Tamrakar
    ...
    try:
        ...
        existing_dataset = load_dataset(HF_REPO_ID, split="train") if os.getenv('HF_TOKEN') else None
...
def main():
    application = ApplicationBuilder().token("7680934008:AAGROX95dKycgPqWvnk2-Llloeix2-MEsrI").build()
